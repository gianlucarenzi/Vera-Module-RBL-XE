...
from the synthesised design:

\begin{center}
\begin{tabular}{lrr}
\toprule
\textbf{Resource} & \textbf{Measured} & \textbf{Available (UP5K)} \\
\midrule
SB\_LUT4 (LUT4 + carry) & 83  & 5280 \\
SB\_FF (flip-flops)     & 10  & 5280 \\
SB\_RAM40\_4K (EBR)     &  5  &   30 \\
SB\_IO (I/O buffers)    & 39  &   39 \\
\textbf{Fmax (CLK)}     & \multicolumn{2}{l}{\textbf{62.72\,MHz} (PASS at 25\,MHz)} \\
\bottomrule
\end{tabular}
\end{center}
...
Adding a third DIP switch bit would require one fewer signal elsewhere.
